...
<div class="flex flex-wrap">
    <div class="w-full md:w-1/2 xl:w-5/6 p-3">
        <div class="bg-white border-transparent rounded-lg shadow-lg">
            <p>Client: <a href="{{ route('clients.view', ['client' => $payment->client_id]) }}">{{ $payment->client->name }}</p>
            <p>Invoice: <a href="{{ route('invoices.view', ['invoice' => $payment->invoice_id]) }}">{{ $payment->invoice_id }}</p>

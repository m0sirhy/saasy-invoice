...
<div class="flex flex-wrap">
    <div class="w-full md:w-1/2 xl:w-5/6 p-3">
        <div class="bg-white border-transparent rounded-lg shadow-lg">
            ...
            <div class = "p-5">
                <form method="POST" action="{{ route('client.merging', ['client' => $client->id]) }}">
                    @csrf
                    <strong>Client ID:</strong> <input type="text" name="old_client_id" class="form-input leading-tight focus:outline-none focus:shadow-outline"><br>
                    <input type="submit" value="Merge Client!">
                </form>
            </div>
        </div>
    </div>
